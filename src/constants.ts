...
export const dialogData: DialogData = {
  ...
  table: `저는 웹 개발자 강효민입니다.<br>다른 분야들 보다도 프론트엔드 개발에 애정을 갖고 가장 집중하고 있어요. 유저와 가장 맞닿아 있는 곳에 위치하여 더 나은 경험을 제공하기 위해 끊임없이 노력하고, 그러한 과정에서 큰 보람을 느끼기도 합니다.<br><br>만약 제 이력서를 확인해보고 싶으시다면, <a href="http://rallit.com/resumes/1272974@gya1" target="_blank">여기를 클릭</a>해 확인해 보실 수 있습니다 :D`,
