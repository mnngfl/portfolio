...
export const dialogData: DialogData = {
  ...
  book: `주로 <code>JavaScript</code> 언어와 <code>React</code>를 기반으로 웹 개발을 하고 있는데, 제 작업물은 저의 <a href="https://github.com/mnngfl" target="_blank">GitHub</a>에서 확인하실 수 있습니다. 또한 개인적으로 공부한 내용을 정리해 <a href="https://velog.io/@seesaw/posts" target="_blank">Blog</a>에 포스팅하고 있기도 합니다.<br><br>유저가 매 순간 편안한 사용 경험을 느끼도록 만드는 것이나, 누군가는 사소하다고 지나쳐 버릴 수도 있는 작은 문제를 해결하는 것에 흥미와 열정을 가지고 있어요.`,
  cat: null,
  radio: null,
  light: null,
};
