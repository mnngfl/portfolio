...
export const dialogData: DialogData = {
  ...
  table: `이 공간을 만든 저는 웹 개발자 강효민입니다 :D<br><br>다른 분야들 보다도 프론트엔드 개발에 애정을 갖고 가장 집중하고 있어요. 유저와 가장 맞닿아 있는 곳에 위치하여 더 나은 사용 경험을 제공하기 위해 끊임없이 노력하고자 하며, 그러한 과정에서 큰 보람을 느끼기도 합니다.<br><br>만약 저에 대한 설명을 조금 더 듣고자 하신다면, 저의 <a href="http://rallit.com/resumes/1272974@gya1" target="_blank">이력서</a>를 확인해 보실 수 있습니다.`,
  ...
  book: `주로 <code>JavaScript</code> 언어와 <code>React</code>를 기반으로 웹 개발을 하고 있는데, 제 작업물은 저의 <a href="https://github.com/mnngfl" target="_blank">GitHub</a>에서 확인하실 수 있습니다. 또한 최근에는 <code>Cloud Service</code>나 <code>DevOps</code>분야로도 관심 영역을 확장해 나가고 있기도 합니다.<br><br>유저가 매 순간 편안한 사용 경험을 느끼도록 만드는 것이나, 누군가는 사소하다고 지나쳐 버릴 수도 있는 작은 문제를 해결하는 것에 흥미와 열정을 가지고 있어요.`,
  cat: null,
  radio: null,
};
